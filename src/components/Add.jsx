  ...
  const getYoutubeEmbedLink = (link)=>{
    ...
    //    Store upload video in http://localhost:3000/videos
        ...
        if(caption && imageURL,youtubeLink){
          // proceed to store video http://localhost:5173/home to http://localhost:3000/
          const result = await uploadVideoAPI(uploadVideo)
          console.log(result);
          if(result.status>=200 && result.status<300){
            alert(`video '${result.data.caption}'uploaded succuccesfully!!!`)
  ...
  return (
    ...
    <Modal
      ...
      >
        ...
        <div className='border rounded border-secondary p-3'><FloatingLabel
